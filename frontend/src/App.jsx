    ...
    <Routes>
      ...
      >
        ...
        <Route
          path='/customers/new'
          element={
            <ProtectedRoute pageName='customers' action='canAdd'>
              <CustomerFormPage />
            </ProtectedRoute>
          }
        />
        ...
        <Route
          ...
          element={
            <ProtectedRoute pageName='customers' action='canEdit'>
              <CustomerFormPage />
            </ProtectedRoute>
          }
        />
        <Route
          path='/samples'
          element={
            <ProtectedRoute pageName='samples'>
              <SampleListPage />
            </ProtectedRoute>
          }
        />
        <Route
          path='/samples/new'
          element={
            <ProtectedRoute pageName='samples' action='canAdd'>
              <SampleFormPage />
            </ProtectedRoute>
          }
        />
        ...
        <Route
          path='/workshop'
          element={
            <ProtectedRoute pageName='workshop'>
              <WorkshopPage />
            </ProtectedRoute>
          }
        />
        ...
        <Route
          path='/results'
          element={
            <ProtectedRoute pageName='results'>
              <ResultsPage />
            </ProtectedRoute>
          }
        />
        <Route
          path='/approvals'
          element={
            <ProtectedRoute pageName='approvals'>
              <ApprovalsPage />
            </ProtectedRoute>
          }
        />
        ...
        <Route
          path='/dispatch'
          element={
            <ProtectedRoute pageName='dispatch'>
              <DispatchPage />
            </ProtectedRoute>
          }
        />
        <Route
          path='/specifications'
          element={
            <ProtectedRoute pageName='specifications'>
              <SpecificationPage />
            </ProtectedRoute>
          }
        />
        ...
        <Route
          path='/tests/new'
          element={
            <ProtectedRoute pageName='tests' action='canAdd'>
              <TestFormPage />
            </ProtectedRoute>
          }
        />
        <Route
          path='/equipment'
          element={
            <ProtectedRoute pageName='equipment'>
              <EquipmentPage />
            </ProtectedRoute>
          }
        />
